...
public class GrizzlyJobsAgentServer {

  private static final Logger log = getLogger(GrizzlyJobsAgentServer.class);
  ...
  public static void main(String...args) throws Exception {
    ...
    ((ch.qos.logback.classic.Logger) getLogger(GrizzlyJobsAgentServer.class)).setLevel(Level.INFO);
